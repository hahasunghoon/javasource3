...
public class FileEx1 {
	...
	public static void main(String[] args) throws IOException {
		...
		// 주요 메소드
		//getName() : 파일명 가져오기
		String fileName = file1.getName();//결과 파일명 test1.txt
		...
		System.out.println(file1.getCanonicalPath()); //밑줄 클릭 -> add (맨위)
		//getParent
		System.out.println("파일이 속해 있는 디렉토리 " + file1.getParent());
		
		//File.pathSeparator : 운영 체제에서 사용되는 경로구분자(윈도우 : ; , 유닉스 : :(콜론))
		System.out.println("File.pathSeparator"+File.pathSeparator); // ;
		System.out.println("File.pathSeparatorChar"+File.pathSeparatorChar); // ;
		//File.separator : 운영 체제에서 사용하는 이름 구분자(윈도우 : \, 유닉스 : /)
