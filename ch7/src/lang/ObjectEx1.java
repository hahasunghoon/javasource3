package lang; //person value

/* java.lang 패키지 : import 구문 없이 사용가능
 *  Object : 모든 클래스의 부모
 * 
 * 
 */
public class ObjectEx1 {
	...
	public static void main(String[] args) {
        ...
        System.out.println("v1 toSting " +v1.toString()); //lang.Value@41a4555e ==>Value[value=10]
        ...
        //toString() 이 오버라이딩이 되어 있다면 참조변수명만 사용해도됌
