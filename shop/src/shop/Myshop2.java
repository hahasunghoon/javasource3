...
public class Myshop2<print> implements IShop {
	...
	public void genProduct() {
		//Product 4개(CellPhone 2개, SmartTv 2개) 생성 후 배열에 저장
				product[0] = new CellPhone("갤럭시 노트 10",500000,"SKT");
				product[1] = new CellPhone("애플 아이폰 13",900000,"U+");
				product[2] = new SmartTv("삼성 3D Smart", 1500000, "4K");
				product[3] = new SmartTv("LG Smart Tv", 1200000, "Full HD");
